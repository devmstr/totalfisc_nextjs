...
Complete Prisma schema for TOTALFisc.

## Overview

The schema is organized into:
- **Tenant & User Management** - Multi-tenancy, users, roles
- **Fiscal Year Management** - Periods, month closures
- **Accounting Core** - Journals, accounts, pieces, transactions
- **Investment & Depreciation** - Asset tracking
...
model Invoice {
  ...
  // Timbre Fiscal (Stamp Duty) - Required for invoices > 20,000 DZD
...
- [Accounting Core](./04-accounting-core.md) - Validation and transaction logic
