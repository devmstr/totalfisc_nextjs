...
async function main() {
  ...
  const journals = [
    ...
    { code: 'BNQ', label: 'Banque', nature: JournalNature.BANQUE },
    {
      code: 'CAI',
      label: 'Caisse',
      nature: JournalNature.TRESORERIE,
      principalAccount: '531000'
    },
  ...
  const accounts = [
    ...
    {
      code: '281000',
      label: 'Amortissements des immob. corporelles',
      type: AccountType.ASSET,
      class: 2
    }, // Contra-asset
    ...
    {
      code: '380000',
      label: 'Achats marchandises stockées',
      type: AccountType.ASSET,
      class: 3
    },
    ...
    {
      code: '752000',
      label: "Plus-values sur cession d'immobilisations",
      type: AccountType.REVENUE,
      class: 7
    }
  ]
  ...
  const auxiliaries = [
    {
      code: 'F001',
      label: 'Fournisseur Général',
      type: AuxiliaryType.FOURNISSEUR
    },
