          ...
          <div>
            ...
            {action && (
              <div className="mt-4">
                <a
                  href={action.href}
                  className="inline-flex items-center justify-center rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-emerald-600 text-white shadow hover:bg-emerald-700 h-9 px-4 py-2"
                >
                  {action.label}
                </a>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <Card className="lg:col-span-2 border-dashed border-slate-200 bg-slate-50/50 shadow-none rounded-3xl overflow-hidden min-h-[400px] flex flex-col items-center justify-center text-center p-8">
          ...
          <p className="text-slate-500 max-w-sm mx-auto text-sm leading-relaxed">
            Nous préparons l'interface de{' '}
            <strong>{t(titleKey).toLowerCase()}</strong>. Bientôt, vous pourrez
            gérer toutes vos opérations ici avec une fluidité exceptionnelle.
          </p>
          ...
          <Card className="bg-slate-900 text-white border-none shadow-2xl rounded-3xl overflow-hidden relative group">
            ...
            <CardContent className="p-8">
              <h3 className="text-lg font-bold mb-6 flex items-center gap-2">
                <span className="w-8 h-8 rounded-lg bg-emerald-500 flex items-center justify-center text-white text-xs">
                  ⚡
                </span>
                Actions rapides
              </h3>
